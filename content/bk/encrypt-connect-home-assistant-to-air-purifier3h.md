...
Cài đặt app `MiHome` latest trên Androids, đăng ký, pair nó với `Air Purifier 3H` của bạn (ấn đồng thời nút bấm sau máy với nút cảm ứng, chờ đến khi 3 tiếng bíp liên tiếp), hãy đảm bảo pair thành công nhé!
