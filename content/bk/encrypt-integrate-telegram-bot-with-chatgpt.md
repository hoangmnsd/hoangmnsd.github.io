...
Check các tham số khác, ngoài `api_key, engine` thì check ở đây: https://github.com/acheong08/ChatGPT/wiki/V3
...
Nếu ko làm bước 1 và vẫn sử dụng Python3.9 thì sẽ bị lỗi sau:  
