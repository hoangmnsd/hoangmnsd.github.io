...
Trong trường hợp đa kế thừa, 1 class Children kế thừa 2 class cha là ParentA và ParentB (ảnh) thì khi trong class Children gọi method sẽ ưu tiên gọi của class cha có thứ tự nhỏ hơn trong MRO  
