...
Cùng lúc đó, vào log check: `tail -200f /var/log/message`, bạn sẽ thấy có rất nhiều package ACCEPT/DROP đã được log lại:  
...
Sau khi theo dõi 1 thời gian thì mình đã bắt dc package bị DROP trong `/var/log/message` đó:  
```
